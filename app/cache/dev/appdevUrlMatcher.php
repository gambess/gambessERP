...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // CostoSystemBundle_homepage
        if ($pathinfo === '/costo') {
            return array (  '_controller' => 'Costo\\SystemBundle\\Controller\\CuentaController::indexAction',  '_route' => 'CostoSystemBundle_homepage',);
        }

        // _list
        if (0 === strpos($pathinfo, '/list') && preg_match('#^/list(?:/(?P<id>[^/]+?))?$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Costo\\SystemBundle\\Controller\\CuentaController::listAction',  'id' => NULL,)), array('_route' => '_list'));
        }

        // _create
        if ($pathinfo === '/create') {
            return array (  '_controller' => 'Costo\\SystemBundle\\Controller\\CuentaController::createAction',  '_route' => '_create',);
        }
