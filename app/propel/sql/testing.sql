...
(
    ...
    `formal_total_venta` FLOAT(7,2) DEFAULT 0.00 NOT NULL,
    `informal_total_venta` FLOAT(7,2) DEFAULT 0.00 NOT NULL,
    `total_iva_venta_formal` FLOAT(7,2) DEFAULT 0.00 NOT NULL,
    `detalle_venta` TEXT,
